...
class ApprovalRequest(models.Model):
    ...
    def send_notification(self, req, action_by, state):
        ...
        if self.res_model == "stock.picking":
            ...
            picking_id = self.env["stock.picking"].browse(self.res_id)
